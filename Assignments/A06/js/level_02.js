...
var level_02 = {
	...
	update: function () {
		...
		this.moveTowardPlayer(slimes.children[1], 10)

		// Back up to Level 01 through Stairs
	
		if ((this.player.x < 52) && (this.player.y <185))
		{
			startX = 851
			startY = 768
		...
		if ((this.player.x > 428)  && (this.player.x < 433) && (this.player.y>240) && (this.player.y <260))
		{
			startX = 200
			startY = 200
			this.game.state.start("level_03");
		}
	...
	// To create many slimes just make a loop that creates desired number and assigns locations
	...
	createSlimes: function(){
		...
		var slime2 = slimes.create(498,355, 'slime')
		slime2.animations.add('move_left', [13,14], 1, true)
		slime2.play('move_left')
		slime2.anchor.setTo(0.5,.5)
		slime2.body.setSize (20,20, 5, 40)
